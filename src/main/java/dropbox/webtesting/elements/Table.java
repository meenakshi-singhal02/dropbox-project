...
public class Table extends Element {
	...
	public void selectRowDetails(String sFileName)
	{
		int rowCount = getRowCount();
		for(int iRowCounter=1;iRowCounter<=rowCount;iRowCounter++)
		{
			String sActualFileName= element.findElement(By.xpath("/tbody/tr[iRowCounter]/td[2]/div[2]//a//span")).getText();
			if(sActualFileName.contains(sFileName))
			{
				element.findElement(By.xpath("/tbody/tr[iRowCounter]/td[1]//input")).click();
			}
		}
	}
